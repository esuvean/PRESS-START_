...
namespace CRTFilter
{
    ...
    public class CRTVolumeComponent : VolumeComponent
    {
        ...
        //Glitches
        public ClampedFloatParameter glitchFrequency = new(value: 1f, min: 0f, max: 1f);
        public ClampedIntParameter glitchBands = new(value: 0, min: 0, max: 100);
        public ClampedFloatParameter glitchPosition = new(value: 0.5f, min: 0f, max: 1f);
        public ClampedFloatParameter glitchPositionFlicker = new(value: 0.3f, min: 0f, max: 1f);
        public ClampedFloatParameter glitchMovementSpeed = new(value: 0f, min: 0f, max: 10f);
        public ClampedFloatParameter glitchStrength = new(value: 0f, min: 0f, max: 1f);
        public ClampedFloatParameter glitchNoise = new(value: 1f, min: 0f, max: 2f);
        public ClampedFloatParameter glitchNoiseSpeed = new(value: 2f, min: 0f, max: 10f);
