...
namespace CRTFilter
{
    public class CRTRendererFeature : ScriptableRendererFeature
    {
        ...
        [Range(0, 100)]
        public int glitchBands = 0;
        [Range(0f, 1f)]
        public float glitchPosition = 0f;
        [Range(0f, 1f)]
        public float glitchPositionFlicker = 0f;
        [Range(0f, 10f)]
        public float glitchMovementSpeed = 0f;
        [Range(0f, 1f)]
        public float glitchStrength = 0f;
        [Range(0f, 2f)]
        public float glitchNoise = 0f;
        [Range(0f, 10f)]
        public float glitchNoiseSpeed = 0f;
        ...
        public void OnValidate()
        {
            ...
            switch (preset)
            {
                case Presets.none:
                    ...
                    glitchBands = 0;
                    glitchPosition = 0;
                    glitchPositionFlicker = 0;
                    glitchMovementSpeed = 0;
                    glitchStrength = 0;
                    glitchNoise = 0;
                    glitchNoiseSpeed = 0;
                    brightness = 1;
                ...
                case Presets.VHS:
                    ...
                    bleed = 0;
                    smidge = 0;
                    scanlinesStrength = 2f;
                    apertureStrength = 0.1f;
                    shadowlines = 8f;
                    shadowlinesSpeed = 1.2f;
                    shadowlinesAlpha = 0.08f;
                    vignetteSize = 5.7f;
                    vignetteSmooth = 2;
                    vignetteRound = 63;
                    noiseSize = 7.6f;
                ...
                case Presets.glitchyCrt:
                    ...
                    noiseAlpha = 0.25f;
                    noiseSpeed = 7.2f;
                    glitchFrequency = 0.08f;
                    glitchBands = 5;
                    glitchPosition = 0;
                    glitchPositionFlicker = 0;
                    glitchMovementSpeed = 8f;
                    glitchStrength = 0.08f;
                    glitchNoise = 0.2f;
                    glitchNoiseSpeed = 0;
                    chromaticAberration = 1.5f;
                    redOffset = Vector2.zero;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchLineSize"), 1f / pixelResolutionY);
            if (volume != null)
            {
                ...
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchFrequency"), volume.glitchFrequency.value);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchBandSize"), 1f / volume.glitchBands.value);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchPositionFlicker"), volume.glitchPositionFlicker.value);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchSpeed"), volume.glitchMovementSpeed.value);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchActiveBand"), Mathf.FloorToInt((volume.glitchBands.value - 1) * volume.glitchPosition.value));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchStrength"), volume.glitchStrength.value);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchDistortion"), Mathf.Min(1f, volume.glitchNoise.value));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchNoise"), Mathf.Max(0f, 2.000001f - volume.glitchNoise.value));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchNoiseSpeed"), (volume.glitchNoiseSpeed.value * 10f) + 2f);
            ...
            else
            {
                ...
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchFrequency"), glitchFrequency);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchBandSize"), 1f / glitchBands);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchPositionFlicker"), glitchPositionFlicker);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchSpeed"), glitchMovementSpeed);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchActiveBand"), Mathf.FloorToInt((glitchBands - 1) * glitchPosition));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchStrength"), glitchStrength);
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchDistortion"), Mathf.Min(1f, glitchNoise));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchNoise"), Mathf.Max(0f, 2.000001f - glitchNoise));
                shaderMaterial.SetFloat(Shader.PropertyToID("p_glitchNoiseSpeed"), (glitchNoiseSpeed * 10f) + 2f);
